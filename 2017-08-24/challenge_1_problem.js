...
function fixer(number, maxDigits) {
  ...
  // Please add one or more conditions and return statements here :)
  // Hint 1:
  // What condition determines which variable to return?
  // Hint 2:
  // if statement and 2 return statements
  // return statement and ternary expression
}

// Tests can specify expected results:
